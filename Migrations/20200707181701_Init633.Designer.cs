...
namespace angular_admin.Migrations
{
    ...
    [Migration("20200707181701_Init633")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("angular_admin.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("angular_admin.Models.Cliente", b =>
                {
            ...
            modelBuilder.Entity("angular_admin.Models.Descripcion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("angular_admin.Models.Estado", b =>
                {
            ...
            modelBuilder.Entity("angular_admin.Models.Productos", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("angular_admin.Models.Servicio", b =>
                {
                    ...
                    b.Property<double>("GastosNetos")
                        .HasColumnType("float");

                    b.Property<string>("IdServicio")
                        .HasColumnType("nvarchar(max)");

                    b.Property<double>("Manobra")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("angular_admin.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("angular_admin.Models.Servicio", b =>
                {
                    ...
                    b.HasOne("angular_admin.Models.Estado", "Estados")
                        .WithMany()
