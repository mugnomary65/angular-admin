...
export class DashboardComponent implements OnInit {
  ...
  getTotalClientes(): void{
    this.dashboardService.getClienteTotal()
    .subscribe(servicioData =>this.clienteTotal = servicioData);
  }
  getTotalServicios(): void{
    this.dashboardService.getTotalServicios()
    .subscribe(servicioData =>this.serviciosTotal = servicioData);
  }
  getGanancias(): void{
   
    this.gananciasService.getGanancias()
